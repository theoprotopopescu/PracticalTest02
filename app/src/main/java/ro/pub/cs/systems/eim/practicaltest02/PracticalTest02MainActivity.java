...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private TextView parityTextView = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            parityTextView.setText(Constants.EMPTY_STRING);

            ClientThread clientThread = new ClientThread(clientAddress, Integer.parseInt(clientPort), currency, parityTextView);
            clientThread.start();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button get_parity_button = findViewById(R.id.get_parity_button);
        get_parity_button.setOnClickListener(getWeatherForecastButtonClickListener);
        parityTextView = findViewById(R.id.parity_text_view);
    }
